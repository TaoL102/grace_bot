...
namespace GraceBot
{
    public class DbManager : IDbManager
    {
        ...
        {
            var activityRecord = _db.Activities.Include(r => r.From).Include(r => r.Recipient).Include(r => r.Conversation).FirstOrDefault(o => o.ActivityId == id);
        ...
        internal ActivityModel ConvertToModel(Activity activity, ProcessStatus? processStatus = null)
        {
        ...
        internal Activity ConvertToActivity(ActivityModel activityModel)
        {
            return new Activity()
            {
